...
export default async function handler(req, res) {
  ...
  const rows = Object.entries(data)
    ...
    .map(([k, v]) => `
      <tr>
        <td style="padding:10px 16px;color:#ffffff;font-size:13px;font-family:sans-serif;border-bottom:1px solid #1a1a1a;white-space:nowrap;vertical-align:top">${k}</td>
...
<body style="background:#080808;margin:0;padding:40px 20px">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto">
    ...
    <tr><td style="padding-bottom:6px">
      <span style="font-family:sans-serif;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#ffffff">New Inquiry</span>
    </td></tr>
    <tr><td style="padding-bottom:28px">
    ...
    <tr><td style="padding-top:36px;border-top:1px solid #1a1a1a;margin-top:36px">
      <span style="font-family:sans-serif;font-size:11px;color:#ffffff">matassa.com &nbsp;·&nbsp; Traditional Craft. Cinematic A.I.</span>
    </td></tr>
  </table>
</body>
</html>`;
